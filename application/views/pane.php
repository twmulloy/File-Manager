<div class="control">
	<a class="button left download active" href="#"><span class="icon downarrow"></span>Download</a><a class="button right upload" href="#"><span class="icon uparrow"></span>Upload</a>
</div>
